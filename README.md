...
```ts
import { tar } from "https://deno.land/x/compress@v0.4.6/mod.ts";
// or only import tar
// import { tar } from "https://deno.land/x/compress@v0.4.6/tar/mod.ts";
...
import {
  ...
  inflate,
  inflateRaw,
} from "https://deno.land/x/compress@v0.4.6/mod.ts";
// or only import deflate, inflate, deflateRaw, inflateRaw
// import { deflate, inflate, deflateRaw, inflateRaw } from "https://deno.land/x/compress@v0.4.6/zlib/mod.ts";
...
// import { gzipFile, gunzipFile } from "https://deno.land/x/compress@v0.4.6/gzip/mod.ts";
...
// import { gzip, gunzip } from "https://deno.land/x/compress@v0.4.6/zlib/mod.ts";
// gzip
...
```ts
import { tgz } from "https://deno.land/x/compress@v0.4.6/mod.ts";
// or only import tgz
// import { tgz } from "https://deno.land/x/compress@v0.4.6/tgz/mod.ts";
export interface compressInterface {
  excludeSrc?: boolean;      // does not contain the src directory
  debug?: boolean;           // list the files and folders
}
...
```ts
import { zip } from "https://deno.land/x/compress@v0.4.6/mod.ts";
export interface compressInterface {
  excludeSrc?: boolean;      // does not contain the src directory
  debug?: boolean;           // list the files and folders
}
